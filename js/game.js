    ...
    play(){
                ...
                if (keyIsDown(LEFT_ARROW) && player.index !== null) {
                 ...
                 if(frameCount % 40 === 0){
                    ...
                    switch(rand){
                        case 1: obstacle.addImage("obs1",obstacleImage);
                        break;
                        case 2: obstacle.addImage("obs2",obstacleImage2);
                        break;
}
                    obstacleGroup.add(obstacle); 
                    obstacleImage.scale=0.3;
                    obstacleImage2.scale=0.2;
